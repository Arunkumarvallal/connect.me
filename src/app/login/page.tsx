...
export default function LoginPage() {
  ...
  /** Temporary handler — real OAuth will be wired up in Phase 2. */
  function handleAuth(provider: 'google' | 'github') {
    toast.info(`${provider === 'google' ? 'Google' : 'GitHub'} auth coming in Phase 2 — loading demo dashboard.`);
